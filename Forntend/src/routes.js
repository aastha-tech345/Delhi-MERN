...
const routes = [
  ...
  { path: '/customer/list', name: 'CustomerList', element: CustomerList },
  { path: '/customer/customer_info', name: 'CustomerInfo', element: CustomerInfo },
  { path: '/customer/contact', name: 'Contact', element: Contact },
  { path: '/customer/bills', name: 'Bills', element: Bills },
  { path: '/customer/tasks', name: 'Tasks', element: Tasks },
  { path: '/customer/description', name: 'Description', element: Description },
  { path: '/customer/document', name: 'Document', element: Document },
  { path: '/customer/services', name: 'Services', element: Services },
  { path: '/settings/users', name: 'User', element: User },
  { path: '/settings/roll', name: 'Roll', element: Roll },
  { path: '/settings/createuser', name: 'CreateUser', element: CreateUser },
  { path: '/settings/team', name: 'Teams', element: Teams },
  { path: '/settings/email', name: 'EmailTempalte', element: EmailTempalte },
