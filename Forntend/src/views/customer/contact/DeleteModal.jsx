...
const DeleteModal = ({ setHide, contactId, getDetails }) => {
  ...
  DeleteModal.propTypes = {
    ...
    contactId: PropTypes.func.isRequired,
  ...
  const handleDeleteConfirm = async () => {
    if (contactId) {
      try {
        const response = await deleteFetch(`${apiUrl}/contact/get_contact`, contactId)
